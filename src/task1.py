...
# Load posts data
posts_df = spark.read.option("header", True).csv("/workspaces/handson-8-spark-sql-and-dataframes-Likithakode/input/posts.csv")
...
# Save result
top_hashtags.coalesce(1).write.mode("overwrite").csv("/workspaces/handson-8-spark-sql-and-dataframes-Likithakode/outputs/hashtag_trends.csv", header=True)
